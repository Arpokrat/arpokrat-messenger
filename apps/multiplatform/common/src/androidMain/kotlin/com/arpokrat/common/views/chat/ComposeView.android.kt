...
import com.arpokrat.common.helpers.toURI
import com.arpokrat.common.platform.androidAppContext
import com.arpokrat.common.platform.resizeImageToStrSize
...
actual fun AttachmentSelection(
  ...
  val cameraPermissionLauncher = rememberPermissionLauncher { isGranted: Boolean ->
    if (isGranted) {
      ...
      AppNotificationManager.showError(generalGetString(MR.strings.toast_permission_denied))
    }
  }
