...
import com.arpokrat.common.model.json
import com.arpokrat.common.platform.*
import com.arpokrat.common.ui.theme.WarningOrange
import com.arpokrat.common.views.onboarding.ReadMoreButton
...
private suspend fun downloadAsset(asset: GitHubAsset) {
  withContext(Dispatchers.Main) {
    AppNotificationManager.showSuccess(generalGetString(MR.strings.app_check_for_updates_download_started))
  }
  ...
  try {
    ...
    chatModel.updatingRequest = Closeable {
      call.cancel()
      withApi {
        AppNotificationManager.showError(generalGetString(MR.strings.app_check_for_updates_canceled))
      }
    }
              ...
              buttons = {
                Column {
                  ...
                  SectionItemView({
                    ...
                    Text(generalGetString(MR.strings.cancel_verb), Modifier.fillMaxWidth(), textAlign = TextAlign.Center, color = MaterialTheme.colors.error)
                  }
                }
              }
            )
