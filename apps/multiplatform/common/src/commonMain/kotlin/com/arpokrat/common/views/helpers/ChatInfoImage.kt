...
@Composable
fun ChatInfoImage(chatInfo: ChatInfo, size: Dp, iconColor: Color? = null, shadow: Boolean = false) {
  val finalIconColor = iconColor ?: MaterialTheme.colors.onBackground
  ...
  ProfileImage(size, chatInfo.image, icon, finalIconColor)
}

@Composable
fun IncognitoImage(size: Dp, iconColor: Color? = null) {
  val finalColor = iconColor ?: MaterialTheme.colors.primary
