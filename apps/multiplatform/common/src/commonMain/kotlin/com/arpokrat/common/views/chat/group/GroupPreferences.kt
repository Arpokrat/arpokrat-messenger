...
import com.arpokrat.common.views.usersettings.PreferenceToggleWithIcon
...
private fun FeatureSection(
  ...
  SectionView {
    ...
    val iconTint = if (on) SimplexGreen else MaterialTheme.colors.error
    ...
    if (groupInfo.isOwner) {
      PreferenceToggleWithIcon(
        ...
        icon,
        iconTint,
        disabled = feature == GroupFeature.Reports,
