...
import com.arpokrat.common.ui.theme.NoteFolderIconColor
  ...
  Row(
    ...
    Row(
      ...
      Text(
        ...
        color = if (disabled) MaterialTheme.colors.secondary else if (chat.chatInfo.incognito) MaterialTheme.colors.primary else MaterialTheme.colors.onBackground
      )
    }
  }
}
