...
import com.arpokrat.common.views.contacts.onRequestAccepted
...
fun JoinGroupAction(
  ...
  ItemAction(
    ...
    color = if (chat.chatInfo.incognito) MaterialTheme.colors.primary else MaterialTheme.colors.onBackground,
    onClick = {
      joinGroup()
      showMenu.value = false
    }
    ...
    buttons = {
      Column {
        ...
        SectionItemView({
          ...
          Text(generalGetString(MR.strings.reject_contact_button), Modifier.fillMaxWidth(), textAlign = TextAlign.Center, color = MaterialTheme.colors.error)
        }
      }
    },
