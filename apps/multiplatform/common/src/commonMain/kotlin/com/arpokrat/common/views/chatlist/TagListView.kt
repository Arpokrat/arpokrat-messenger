...
import com.arpokrat.common.model.ChatController.apiDeleteChatTag
import com.arpokrat.common.model.ChatController.apiSetChatTags
import com.arpokrat.common.model.ChatController.appPrefs
import com.arpokrat.common.model.ChatModel.clearActiveChatFilterIfNeeded
...
import com.arpokrat.common.views.chat.item.ReactionIcon
    ...
    SectionCustomFooter {
      Row(
        ...
        Icon(
          ...
          tint = if (showErrorMessage) MaterialTheme.colors.error else Color.Transparent,
          modifier = Modifier
            .size(19.sp.toDp())
            .offset(x = 2.sp.toDp())
        )
