...
import com.arpokrat.common.views.chatlist.UserProfilePickerItem
import com.arpokrat.common.views.chatlist.UserProfileRow
import com.arpokrat.common.views.helpers.*
import com.arpokrat.common.views.CreateProfile
          ...
          buttons = {
            Column {
              SectionItemView({
                ...
                Text(stringResource(MR.strings.users_delete_with_connections), Modifier.fillMaxWidth(), textAlign = TextAlign.Center, color = MaterialTheme.colors.error)
              }
              SectionItemView({
                AlertManager.shared.hideAlert()
                ...
                Text(stringResource(MR.strings.users_delete_data_only), Modifier.fillMaxWidth(), textAlign = TextAlign.Center, color = MaterialTheme.colors.error)
              }
            }
          }
        )
...
private fun UserView(
  ...
  Box(Modifier.padding(horizontal = DEFAULT_PADDING)) {
    DefaultDropdownMenu(showMenu) {
      ...
      ItemAction(stringResource(MR.strings.delete_verb), painterResource(MR.images.ic_delete), color = MaterialTheme.colors.error, onClick = {
        removeUser(user)
        showMenu.value = false
      })
    }
  ...
  ColumnWithScrollBar {
    ...
    when (action) {
      UserProfileAction.DELETE -> {
        ...
        PasswordAndAction(MR.strings.delete_chat_profile, color = MaterialTheme.colors.error)
        if (actionEnabled) {
