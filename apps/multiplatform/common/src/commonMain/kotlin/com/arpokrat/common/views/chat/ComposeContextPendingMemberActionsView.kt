...
import com.arpokrat.common.views.chat.group.removeMember
import com.arpokrat.common.views.chat.group.removeMemberDialog
  ...
  Column(
    ...
    Row(
      ...
      Column(
        ...
        Text(stringResource(MR.strings.reject_pending_member_button), color = MaterialTheme.colors.error)
      }
