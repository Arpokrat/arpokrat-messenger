...
import com.arpokrat.common.ui.theme.ThemeManager.toReadableHex
...
val BlackColorPalette = darkColors(
  ...
  secondaryVariant = Color(0xFFB0B0B0),
  error = Color(0xFFF85D4D),
...
val BlackColorPaletteApp = AppColors(
  ...
  primaryVariant2 = Color(0xFF1C1C1E),
  sentMessage = Color(0xFF2C2C2E),
  sentQuote = Color(0xFF3A3A3C),
  receivedMessage = Color(0xFF151515),
  receivedQuote = Color(0xFF252525),
)
