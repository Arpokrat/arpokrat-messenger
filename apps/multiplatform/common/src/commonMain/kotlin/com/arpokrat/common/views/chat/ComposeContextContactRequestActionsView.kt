...
import com.arpokrat.common.views.chatlist.acceptContactRequest
import com.arpokrat.common.views.chatlist.rejectContactRequest
      ...
      Row(
        ...
        Row(
          ...
          Icon(
            ...
            tint = if (inProgress.value) MaterialTheme.colors.secondary else MaterialTheme.colors.error,
          )
          TextIconSpaced(false)
          Text(
            stringResource(MR.strings.reject_contact_button),
            color = if (inProgress.value) MaterialTheme.colors.secondary else MaterialTheme.colors.error
          )
        }
