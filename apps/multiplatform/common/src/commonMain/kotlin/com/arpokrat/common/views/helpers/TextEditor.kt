...
import com.arpokrat.common.model.FormattedText
...
fun TextEditor(
  ...
  // CORRECTION : On lit les couleurs directement dans la fonction @Composable
  val errorColor = MaterialTheme.colors.error
  val secondaryColor = CurrentColors.value.colors.secondary

  // On calcule la couleur simplement, sans derivedStateOf
  val strokeColor = if (valid) {
    if (focused) secondaryColor.copy(alpha = 0.6f) else secondaryColor.copy(alpha = 0.3f)
  } else {
    errorColor
  }
