package com.arpokrat.common.model
...
import com.arpokrat.common.model.ChatController.getNetCfg
import com.arpokrat.common.model.ChatController.setNetCfg
import com.arpokrat.common.model.ChatModel.changingActiveUserMutex
import com.arpokrat.common.model.MsgContent.MCUnknown
import com.arpokrat.common.platform.*
import com.arpokrat.common.ui.theme.*
import com.arpokrat.common.views.call.*
import com.arpokrat.common.views.chat.item.showContentBlockedAlert
import com.arpokrat.common.views.chat.item.showQuotedItemDoesNotExistAlert
import com.arpokrat.common.views.chatlist.openGroupChat
import com.arpokrat.common.views.helpers.*
import com.arpokrat.common.views.migration.MigrationFileLinkData
import com.arpokrat.common.views.onboarding.OnboardingStage
import com.arpokrat.common.views.usersettings.*
import com.arpokrat.common.views.usersettings.networkAndServers.serverHostname
...
class AppPreferences {
  ...
  val logLevel = mkEnumPreference(SHARED_PREFS_LOG_LEVEL, LogLevel.WARNING) { LogLevel.entries.firstOrNull { it.name == this } } // TODO In prod, replace WARNING by ERROR
  ...
  val currentTheme = mkStrPreference(SHARED_PREFS_CURRENT_THEME, DefaultTheme.BLACK.themeName)
  val systemDarkTheme = mkStrPreference(SHARED_PREFS_SYSTEM_DARK_THEME, DefaultTheme.BLACK.themeName)
  ...
  val profileImageCornerRadius = mkFloatPreference(SHARED_PREFS_PROFILE_IMAGE_CORNER_RADIUS, 50.0f)
  val chatItemRoundness = mkFloatPreference(SHARED_PREFS_CHAT_ITEM_ROUNDNESS, 1.0f)
  ...
  companion object {
    const val SHARED_PREFS_ID = "com.arpokrat.app.SIMPLEX_APP_PREFS"
    internal const val SHARED_PREFS_THEMES_ID = "com.arpokrat.app.THEMES"
    ...
    when (r) {
      ...
      is CR.CallOffer -> {
        ...
        withCall(r, r.contact) { call ->
          ...
          val activeJurisdictions = chatModel.conditions.value.serverOperators
            .filter { it.enabled }
            .joinToString(separator = " ") { it.tradeName }

          val iceServers = getIceServers(activeJurisdictions)
          ...
          when (r.rhStopReason) {
            ...
            is RemoteHostStopReason.Disconnected -> {
              if (r.rhsState is RemoteHostSessionState.Connected || r.rhsState is RemoteHostSessionState.Confirmed) {
                AppNotificationManager.showError(generalGetString(MR.strings.remote_host_was_disconnected_toast).format(deviceName))
              }
            }
          }
        }
...
enum class OperatorTag {
  @SerialName("switzerland") SWITZERLAND,
  @SerialName("iceland") ICELAND,
  @SerialName("panama") PANAMA,
  @SerialName("malaysia") MALAYSIA,
  @SerialName("southafrica") SOUTH_AFRICA
}
...
val operatorsInfo: Map<OperatorTag, ServerOperatorInfo> = mapOf(
  OperatorTag.SWITZERLAND to ServerOperatorInfo(
    description = listOf("Arpokrat Switzerland Relay.", "Hosted in privacy-friendly Switzerland."),
    website = "https://arpokrat.com",
  ...
  OperatorTag.ICELAND to ServerOperatorInfo(
    description = listOf("Arpokrat Iceland Relay.", "Hosted in privacy-friendly Iceland."),
    website = "https://arpokrat.com",
    logo = MR.images.decentralized,
    largeLogo = MR.images.logo,
    logoDarkMode = MR.images.decentralized_light,
  ...
  OperatorTag.PANAMA to ServerOperatorInfo(
    description = listOf("Arpokrat Panama Relay.", "Hosted in privacy-friendly Panama."),
    website = "https://arpokrat.com",
    logo = MR.images.decentralized,
    largeLogo = MR.images.logo,
    logoDarkMode = MR.images.decentralized_light,
  ...
  OperatorTag.MALAYSIA to ServerOperatorInfo(
    description = listOf("Arpokrat Malaysia Relay.", "Hosted in privacy-friendly Malaysia."),
    website = "https://arpokrat.com",
    logo = MR.images.decentralized,
    largeLogo = MR.images.logo,
    logoDarkMode = MR.images.decentralized_light,
  ...
  OperatorTag.SOUTH_AFRICA to ServerOperatorInfo(
    description = listOf("Arpokrat South Africa Relay.", "Hosted in privacy-friendly South Africa."),
    website = "https://arpokrat.com",
    logo = MR.images.decentralized,
    largeLogo = MR.images.logo,
    logoDarkMode = MR.images.decentralized_light,
...
data class ServerOperator(
  ...
  companion object {
    ...
    val sampleData1 = ServerOperator(
      operatorId = 1,
      operatorTag = OperatorTag.SWITZERLAND,
      tradeName = "Switzerland Relay",
      legalName = "Arpokrat CH",
      serverDomains = listOf("arpokrat.com"),
    ...
    if (jRes is JsonObject) {
      ...
      try {
        if (type == "apiChats") {
          ...
          val user: UserRef = json.decodeFromJsonElement(jRes["user"]!!.jsonObject)
          val chat = parseChatData(jRes["com"]!!)
  ...
  companion object {
    val defaults: AppSettings
      get() = AppSettings(
        ...
        uiChatItemTail = true,
        uiColorScheme = DefaultTheme.DARK.themeName,
        uiDarkColorScheme = DefaultTheme.BLACK.themeName,
