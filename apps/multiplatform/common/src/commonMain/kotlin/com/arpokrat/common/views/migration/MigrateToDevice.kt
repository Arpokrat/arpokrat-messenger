package com.arpokrat.common.views.migration
...
import com.arpokrat.common.model.AppPreferences.Companion.SHARED_PREFS_MIGRATION_TO_STAGE
import com.arpokrat.common.model.ChatController.appPrefs
import com.arpokrat.common.model.ChatController.getNetCfg
import com.arpokrat.common.model.ChatController.startChat
import com.arpokrat.common.model.ChatCtrl
...
import com.arpokrat.common.views.helpers.DatabaseUtils.ksDatabasePassword
...
import com.arpokrat.common.views.usersettings.networkAndServers.OnionRelatedLayout
...
sealed class MigrationToState {
  ...
  @Serializable data class Migration(val passphrase: String, val confirmation: com.arpokrat.common.views.helpers.MigrationConfirmation, val useKeychain: Boolean, val netCfg: NetCfg, val networkProxy: NetworkProxy?): MigrationToState()
}
