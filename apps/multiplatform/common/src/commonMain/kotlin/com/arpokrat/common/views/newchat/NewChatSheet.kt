...
import com.arpokrat.common.views.chat.item.CIFileViewScope
import com.arpokrat.common.views.chat.topPaddingToContent
import com.arpokrat.common.views.chatlist.*
import com.arpokrat.common.views.contacts.*
...
private fun ModalData.NewChatSheetLayout(
  ...
  val allChats by remember(chatModel.chats.value, contactTypes) {
    derivedStateOf { filterContactTypes(chatModel.chats.value, contactTypes)
      .filter { it.chatInfo.chatViewName != "SimpleX" } // TODO Create a bot
    }
  }
