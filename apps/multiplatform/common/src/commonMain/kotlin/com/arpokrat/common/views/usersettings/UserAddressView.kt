...
import com.arpokrat.common.views.chat.ShareAddressButton
...
private fun AcceptIncognitoToggle(addressSettingsState: MutableState<AddressSettingsState>) {
  PreferenceToggleWithIcon(
    ...
    if (addressSettingsState.value.autoAcceptIncognito) MaterialTheme.colors.primary else MaterialTheme.colors.onBackground,
