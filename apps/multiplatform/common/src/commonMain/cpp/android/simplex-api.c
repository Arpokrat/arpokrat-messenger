...
Java_com_arpokrat_common_platform_CoreKt_pipeStdOutToSocket(JNIEnv *env, __unused jclass clazz, jstring socket_name) {
...
Java_com_arpokrat_common_platform_CoreKt_initHS(__unused JNIEnv *env, __unused jclass clazz) {
    int argc = 5;
    char *argv[] = {
        "simplex",
...
Java_com_arpokrat_common_platform_CoreKt_chatMigrateInit(JNIEnv *env, __unused jclass clazz, jstring dbPath, jstring dbKey, jstring confirm) {
...
Java_com_arpokrat_common_platform_CoreKt_chatCloseStore(JNIEnv *env, __unused jclass clazz, jlong controller) {
    jstring res = (*env)->NewStringUTF(env, chat_close_store((void*)controller));
    return res;
}

JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatSendCmdRetry(JNIEnv *env, __unused jclass clazz, jlong controller, jstring msg, jint retryNum) {
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatSendRemoteCmdRetry(JNIEnv *env, __unused jclass clazz, jlong controller, jint rhId, jstring msg, jint retryNum) {
    const char *_msg = (*env)->GetStringUTFChars(env, msg, JNI_FALSE);
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatRecvMsg(JNIEnv *env, __unused jclass clazz, jlong controller) {
    return (*env)->NewStringUTF(env, chat_recv_msg((void*)controller));
}

JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatRecvMsgWait(JNIEnv *env, __unused jclass clazz, jlong controller, jint wait) {
    return (*env)->NewStringUTF(env, chat_recv_msg_wait((void*)controller, wait));
}

JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatParseMarkdown(JNIEnv *env, __unused jclass clazz, jstring str) {
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatParseServer(JNIEnv *env, __unused jclass clazz, jstring str) {
    const char *_str = (*env)->GetStringUTFChars(env, str, JNI_FALSE);
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatParseUri(JNIEnv *env, __unused jclass clazz, jstring str, jint safe) {
    const char *_str = (*env)->GetStringUTFChars(env, str, JNI_FALSE);
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatPasswordHash(JNIEnv *env, __unused jclass clazz, jstring pwd, jstring salt) {
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatValidName(JNIEnv *env, jclass clazz, jstring name) {
...
Java_com_arpokrat_common_platform_CoreKt_chatJsonLength(JNIEnv *env, jclass clazz, jstring str) {
    const char *_str = (*env)->GetStringUTFChars(env, str, JNI_FALSE);
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatWriteFile(JNIEnv *env, jclass clazz, jlong controller, jstring path, jobject buffer) {
...
JNIEXPORT jobjectArray JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatReadFile(JNIEnv *env, jclass clazz, jstring path, jstring key, jstring nonce) {
    const char *_path = (*env)->GetStringUTFChars(env, path, JNI_FALSE);
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatEncryptFile(JNIEnv *env, jclass clazz, jlong controller, jstring from_path, jstring to_path) {
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatDecryptFile(JNIEnv *env, jclass clazz, jstring from_path, jstring key, jstring nonce, jstring to_path) {
    const char *_from_path = (*env)->GetStringUTFChars(env, from_path, JNI_FALSE);
    const char *_key = (*env)->GetStringUTFChars(env, key, JNI_FALSE);
    const char *_nonce = (*env)->GetStringUTFChars(env, nonce, JNI_FALSE);
    const char *_to_path = (*env)->GetStringUTFChars(env, to_path, JNI_FALSE);
