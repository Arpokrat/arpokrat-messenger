...
Java_com_arpokrat_common_platform_CoreKt_initHS(JNIEnv *env, jclass clazz) {
#ifdef _WIN32
    int argc = 4;
...
Java_com_arpokrat_common_platform_CoreKt_chatMigrateInit(JNIEnv *env, jclass clazz, jstring dbPath, jstring dbKey, jstring confirm) {
...
Java_com_arpokrat_common_platform_CoreKt_chatCloseStore(JNIEnv *env, jclass clazz, jlong controller) {
    jstring res = decode_to_utf8_string(env, chat_close_store((void*)controller));
    return res;
}

JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatSendCmdRetry(JNIEnv *env, jclass clazz, jlong controller, jstring msg, jint retryNum) {
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatSendRemoteCmdRetry(JNIEnv *env, jclass clazz, jlong controller, jint rhId, jstring msg, jint retryNum) {
    const char *_msg = encode_to_utf8_chars(env, msg);
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatRecvMsg(JNIEnv *env, jclass clazz, jlong controller) {
    return decode_to_utf8_string(env, chat_recv_msg((void*)controller));
}

JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatRecvMsgWait(JNIEnv *env, jclass clazz, jlong controller, jint wait) {
    return decode_to_utf8_string(env, chat_recv_msg_wait((void*)controller, wait));
}

JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatParseMarkdown(JNIEnv *env, jclass clazz, jstring str) {
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatParseServer(JNIEnv *env, jclass clazz, jstring str) {
    const char *_str = encode_to_utf8_chars(env, str);
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatParseUri(JNIEnv *env, jclass clazz, jstring str, jint safe) {
    const char *_str = encode_to_utf8_chars(env, str);
...
JNIEXPORT jstring JNICALL
Java_com_arpokrat_common_platform_CoreKt_chatPasswordHash(JNIEnv *env, jclass clazz, jstring pwd, jstring salt) {
