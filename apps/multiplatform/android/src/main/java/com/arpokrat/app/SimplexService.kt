...
import com.arpokrat.common.helpers.requiresIgnoringBattery
    ...
    withLongRunningApi {
      ...
      try {
        ...
        if (chatDbStatus != DBMigrationResult.OK) {
          Log.w(com.arpokrat.app.TAG, "SimplexService: problem with the database: $chatDbStatus")
...
//        }
  ...
  companion object {
    ...
    const val NOTIFICATION_CHANNEL_ID = "com.arpokrat.app.SIMPLEX_SERVICE_NOTIFICATION"
    ...
    private const val SHARED_PREFS_ID = "com.arpokrat.app.SIMPLEX_SERVICE_PREFS"
