    ...
    { agentConfig =
      ...
      presetServers =
        PresetServers
          { operators =
              [ PresetOperator
                  { operator = Just operatorSwitzerland,
                    smp = chSMPServers,
                    useSMP = 1,
                    xftp = chXFTPServers,
                    useXFTP = 1
                ...
                PresetOperator
                  { operator = Just operatorMalaysia,
                    smp = mySMPServers,
                    useSMP = 0,
                    xftp = myXFTPServers,
                    useXFTP = 0
                ...
                PresetOperator
                  { operator = Just operatorSouthAfrica,
                    smp = zaSMPServers,
                    useSMP = 0,
                    xftp = zaXFTPServers,
                    useXFTP = 0
